...
'''
import time
from udemylib.errors import WaitForElementError
...
class Page(object):
    '''
    Generic Page class, use a a parent to all Pages
    Contain basic functionalities for find and display elements
    '''
    timeout_seconds = 20
    sleep_interval = .25
